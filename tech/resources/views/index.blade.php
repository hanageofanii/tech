...
<body class="bg-6">
    ...
    <section id="service" class="py-40 text-gray-800 dark:text-white" style="background-color: #161A4C;">
        <div class="container mx-auto px-4 py-8">
            <h2 class="text-3xl font-semibold text-center text-white dark:text-gray-200 mb-8">
                Our Services
            </h2>
        ...
        <footer>
            <div class="py-4 text-black font-semibold items-center bg-5">
                <div class="container px-4 mx-auto">
                    <div class="flex flex-wrap justify-center sm:justify-between">
                        ...
                        <div class="px-8 my-4 w-full sm:w-auto xl:w-1/5 text-center sm:text-left">
                            ...
                            {{-- <div class="mt-2 flex justify-center sm:justify-start">
                                <a href="https://facebook.com" target="_blank"
                                    class="text-blue-600 hover:text-blue-800 mx-3">
                                    <i class="fab fa-facebook-f text-2xl"></i>
                                </a>
                                <a href="https://twitter.com" target="_blank"
                                    class="text-blue-400 hover:text-blue-600 mx-3">
                                    <i class="fab fa-twitter text-2xl"></i>
                                </a>
                                <a href="https://instagram.com" target="_blank"
                                    class="text-pink-600 hover:text-pink-800 mx-3">
                                    <i class="fab fa-instagram text-2xl"></i>
                                </a>
                                <a href="https://linkedin.com" target="_blank"
                                    class="text-blue-700 hover:text-blue-900 mx-3">
                        ...
                        <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5 text-center sm:text-left">
                            <div>
                                <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Connect With
                                    Us
                                </h2>
                            </div>
                            <div class="flex justify-center gap-4">
            ...
            <footer class=" text-white p-4" style="background-color: #161A4C">
                <div class="container mx-auto text-center">
                    <p>&copy; 2024 CV RAMA TEHNIK. All rights reserved.</p>
                </div>
            </footer>
    </section>
